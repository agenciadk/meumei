...
const CompanySetup: React.FC<CompanySetupProps> = ({ onConfirm }) => {
  ...
  const handleSubmit = () => {
      ...
      if (startDate < COMPANY_DATA.monthStartISO) {
          setError('Selecione uma data dentro do mês de Dezembro.');
          return;
      }
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5 flex gap-4">
                ...
                <div className="space-y-1.5">
                    <h3 className="text-sm font-bold text-blue-400">Mês de Referência: Dezembro</h3>
                    <p className="text-sm text-blue-200/80 leading-relaxed">
                        Como o mês já iniciou, sugerimos definir a data de abertura como <strong>01/12/2025</strong>. 
                ...
                <div className="space-y-3">
                    ...
                    {error ? (
                        ...
                        <p className="text-xs text-zinc-500 ml-1 font-medium">
                            Selecione uma data a partir de 01/12/2025
                        </p>
                    )}
                </div>
            </div>
